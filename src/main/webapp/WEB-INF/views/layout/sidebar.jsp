...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <symbol id="file" viewBox="0 0 16 16">
        <path d="M8 0C3.58 0 0 3.58 0 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 14C4.69 14 2 11.31 2 8s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm-1-8h2v3h2l-3 4-3-4h2z"/>
    </symbol>
</svg>
...
<div id="sidebar" class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary w-280">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="/file/upload" class="nav-link link-body-emphasis">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="/assets/images/logo.jpeg" alt="" width="32" height="32" class="rounded-circle me-2">
                <strong class="text-dark">${loggedInUser}</strong>
            </a>
